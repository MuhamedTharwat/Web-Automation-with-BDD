Feature: User Registration
  ...
  Scenario Outline: user can not register with already Registered email
    ...
    Examples:
      ...
      | Muhamed | Tharwat | jigiko4865qa5a@dekaps.com | P@ssw0rd | The specified email already exists|
  ...
  Scenario Outline: "<FieldName>" field is required
    ...
    Examples:
      ...
      | First Name |         | Tharwat | jigiko4865qa5a@dekaps.com | P@ssw0rd | First name is required. |
      | Last Name  | Muahmed |         | jigiko4865qa5a@dekaps.com | P@ssw0rd | Last name is required.  |
      | Password  | Muahmed | Tharwat | jigiko4865qa5a@dekaps.com |          | Password is required.   |
