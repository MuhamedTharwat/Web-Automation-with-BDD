Feature: User Registration
  ...
  Scenario: user register with required valid credentials
    Given user enter valid credentials "Muhamed" "Tharwat" "jigiko4a865qsq2aqas5a@dekaps.com" "P@ssw0rd"
  ...
  Scenario Outline: user can not register with already Registered email
    ...
    Examples:
      ...
      | Muhamed | Tharwat | jigiko4865qa5aa@dekaps.com | P@ssw0rd | The specified email already exists|
  ...
  Scenario Outline: "<FieldName>" field is required
    ...
    Examples:
      ...
      | First Name |         | Tharwat | jigiko4865qa5aa@dekaps.com | P@ssw0rd | First name is required. |
      | Last Name  | Muahmed |         | jigiko4865qa5aa@dekaps.com | P@ssw0rd | Last name is required.  |
      | Password  | Muahmed | Tharwat | jigiko4865qa5aa@dekaps.com |          | Password is required.   |
